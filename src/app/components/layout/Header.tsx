...
const Header = () => {
  ...
  return (
    <div className='navbar bg-light-background flex items-center text-light-onPrimaryContainer py-4'>
      <div className='container flex'>
        <nav className='navbar-left flex items-center gap-5 w-1/3 lg:w-2/3'>
          <Link href={'/'}>
        ...
        <div className='navbar-right flex gap-3 justify-end items-center w-2/3 lg:w-1/3'>
