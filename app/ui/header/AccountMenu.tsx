...
function AccountMenu({ display }: { display: string }) {
  return (
    <ul
      className={`top-13 fixed right-5 z-50 w-52 space-y-1 bg-light-surface ${display}`}
    >
      <li>
        <a
          href="/dashboard"
          className="flex items-center gap-2 rounded-lg px-4 py-2 hover:bg-palettes-primary-98 hover:text-light-primary"
        >
          <svg
